 ...
 */
export function find(list, predicate, ac) {
	if (ac === undefined) {
		ac = Array.prototype;
	}
 ...
 * @prettierignore
 */
export function freeze(object, oc) {
	if (oc === undefined) {
		oc = Object;
	}
 ...
 */
export var HTML_BOOLEAN_ATTRIBUTES = freeze({
 ...
 * @see https://html.spec.whatwg.org/#attributes-3
 */
export function isHTMLBooleanAttribute(name) {
 ...
 */
export var HTML_VOID_ELEMENTS = freeze({
	area: true,
	base: true,
	br: true,
	col: true,
 ...
 * @see https://html.spec.whatwg.org/#void-elements
 */
export function isHTMLVoidElement(tagName) {
 ...
 */
export var HTML_RAW_TEXT_ELEMENTS = freeze({
	script: false,
	style: false,
	textarea: true,
	title: true,
 ...
 * @see https://html.spec.whatwg.org/#escapable-raw-text-elements
 */
export function isHTMLRawTextElement(tagName) {
 ...
 * @see https://html.spec.whatwg.org/#escapable-raw-text-elements
 */
export function isHTMLEscapableRawTextElement(tagName) {
	var key = tagName.toLowerCase();
	return hasOwn(HTML_RAW_TEXT_ELEMENTS, key) && HTML_RAW_TEXT_ELEMENTS[key];
}
/**
 ...
 */
export function hasDefaultHTMLNamespace(mimeType) {
...
// export const HTML_BOOLEAN_ATTRIBUTES = HTML_BOOLEAN_ATTRIBUTES;
// export const HTML_RAW_TEXT_ELEMENTS = HTML_RAW_TEXT_ELEMENTS;
// export const HTML_VOID_ELEMENTS = HTML_VOID_ELEMENTS;
// export const hasDefaultHTMLNamespace = hasDefaultHTMLNamespace;
// export const hasOwn = hasOwn;
// export const isHTMLBooleanAttribute = isHTMLBooleanAttribute;
// export const isHTMLRawTextElement = isHTMLRawTextElement;
// export const isHTMLEscapableRawTextElement = isHTMLEscapableRawTextElement;
// export const isHTMLMimeType = isHTMLMimeType;
// export const isHTMLVoidElement = isHTMLVoidElement;
// export const isValidMimeType = isValidMimeType;
