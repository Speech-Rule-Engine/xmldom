...
export var DOMExceptionName = conventions.freeze({
	/**
 ...
 */
export function DOMException(messageOrCode, nameOrMessage) {
 ...
 * @param {any} [locator]
 */
export function ParseError(message, locator) {
...
// export const DOMExceptionName = DOMExceptionName;
// export const ExceptionCode = ExceptionCode;
