 ...
 * @see {@link onWarningStopParsing}
 */
export function onErrorStopParsing(level) {
 ...
 * @see {@link onErrorStopParsing}
 */
export function onWarningStopParsing() {
	throw 'onWarningStopParsing';
}

export const __DOMHandler = DOMHandler;
// export const DOMParser = DOMParser;
// export const normalizeLineEndings = normalizeLineEndings;
// export const onErrorStopParsing = onErrorStopParsing;
// export const onWarningStopParsing = onWarningStopParsing;
