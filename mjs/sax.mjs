 ...
 * @returns {ParseUtils}
 */
export function parseUtils(source, start) {
	var index = start;
 ...
 */
export function parseDoctypeCommentOrCData(source, start, domBuilder, errorHandler, isHTML) {
...
// export const XMLReader = XMLReader;
// export const parseUtils = parseUtils;
// export const parseDoctypeCommentOrCData = parseDoctypeCommentOrCData;
